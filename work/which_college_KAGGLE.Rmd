...
---
# Update: May 14, 2017
Since submitting this script back in January 2016, which mentioned the possibility of putting a Shiny GUI on it,
I did indeed wrap it in Shiny as well as update the code, model and data.  If you're interested, go to the 
web-based Shinyapp **["Best Colleges for You"](https://thompsonml.shinyapps.io/BestCollegeApp/)** -- hosted at
[shinyapps.io by RStudio](https://www.shinyapps.io/).  
Have fun! 

And let me know what you think at [my LinkedIn page](https://www.linkedin.com/in/mlthomps).
...
```{r roadtrip, eval=TRUE, echo=TRUE, tidy=TRUE}
