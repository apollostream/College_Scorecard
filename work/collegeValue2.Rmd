...
**IMPORTANT: This is a stab serving as an exploratory data analysis.**
...
```{r biplot, warning=FALSE,message=FALSE,fig.height=9,fig.width=10}
...
tsne_coef_df %>% 
  mutate( mag = sqrt(Y1^2 + Y2^2) ) %>%
  {
    ggplot(., aes( x = Y1, y = Y2 ) ) +
      ...
      ggtitle( "t-SNE Biplot" , subtitle = "(blue = item, red = dimension)") +
      theme( text = element_text( face = 'bold' ) )
  } %>%
  print()
